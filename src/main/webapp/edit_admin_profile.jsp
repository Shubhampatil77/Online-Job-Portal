			...
			<div class="col-md-4 offset-md-4">
				<div class="card">
					<div class="card-body">
						...
						<form action="update_profile2" method="post">
							...
							<div class="form-group">
								<label>Enter Address</lable><input type="text"
									required="required" class="form-control" id="exampleInputEmail"
									aria-describedly="emailHelp" name="address"
									value="${adminobj.address}">
							</div>
							<div class="form-group">
								<label>Enter Contact</lable><input type="text" required="required"
									class="form-control" id="exampleInputEmail"
									aria-describedly="emailHelp" name="contact"
									value="${adminobj.contact }">
							</div>
							<div class="form-group">
								<label>Enter Password</lable><input type="password" required="required"
									class="form-control" id="exampleInputEmail"
